...
int main(void) {
	...
	const struct aiScene* scene = aiImportFile( "assets/Small/Small_Chest.obj",
	...
	unsigned char *texData = stbi_load("assets/Small/SmalMM00.png", &texWidth, &texHeight, &nrChannels, 0);
	if(texData) {
